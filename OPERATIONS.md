...
| Phase | Content | State |
|---|---|---|
| H0 | Repo bootstrap: charter, operations, skeleton, vocabulary draft, mockups, public repo | in progress |
| H1 | Evaluation-context review → `content/model/` chapters | planned |
